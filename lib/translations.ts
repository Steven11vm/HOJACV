...
export const translations = {
  es: {
    ...
    about: {
      ...
      bio2: "Trabajo end-to-end: desde la arquitectura y las decisiones técnicas hasta el despliegue en producción y su evolución. Combino",
      bio2b: "React, Next.js, Node e IA generativa",
      bio2c: "(Gemini, Claude, OpenAI) para llevar producto real a manos de usuarios reales — rápido, sin sobredimensionar y sin drama.",
      bio3:
  ...
  en: {
    ...
    about: {
      ...
      bio2: "I work end-to-end: from architecture and technical decisions to production deployment and its evolution. I combine",
      bio2b: "React, Next.js, Node and generative AI",
      bio2c: "(Gemini, Claude, OpenAI) to put real product in real users' hands — fast, right-sized and drama-free.",
      bio3:
