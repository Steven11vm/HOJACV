...
const TXT = {
  es: {
    eyebrow: "07 · Cotización",
    subEyebrow: "7 pasos · MMXXV",
    title: "Vamos a arrancar tu proyecto.",
    lede: "Siete pasos cortos para llegar a mi WhatsApp con todo el contexto y agendar la call de 30 min gratis. Sin formularios largos, sin cotizaciones al aire.",
    ...
    steps: [
      { tag: "Contexto",       principle: "Ancla cognitiva",           title: "El mercado cotiza esto entre US$ 3k y US$ 15k.",  sub: "Referencia real para que puedas comparar precios de forma justa." },
      { tag: "Disponibilidad", principle: "Escasez",                    title: "Solo 3 proyectos por mes.",                        sub: "Trabajo end-to-end en cada uno — no puedo escalar sin sacrificar calidad." },
      { tag: "Beneficios",     principle: "Reciprocidad",               title: "Antes de que decidas, esto va gratis.",            sub: "Tres entregables reales sin compromiso — para que veas cómo trabajo." },
      { tag: "Casos",          principle: "Prueba social",              title: "Ya lo hicimos, 20 veces.",                          sub: "Los números y las marcas que respaldan cada afirmación." },
      { tag: "Planes",         principle: "Contraste perceptual",       title: "Tres planes lado a lado.",                          sub: "Elige el que mejor calza con lo que necesitas. Se ajusta en la call." },
      { tag: "Stack",          principle: "Autoridad prestada",         title: "Mismo stack que Netflix, Anthropic y Vercel.",      sub: "No aprendo tech de moda; uso lo que producción del mundo real validó." },
      { tag: "Decisión",       principle: "Compromiso + consistencia",  title: "Tres preguntas cortas y estás dentro.",             sub: "Cerramos con un siguiente paso concreto y sin ambigüedad." },
    ],
    anchor: {
  ...
  en: {
    ...
    steps: [
      { tag: "Context",       principle: "Cognitive anchor",           title: "The market prices this at US$ 3k–15k.",              sub: "A real reference so you can compare prices fairly." },
      { tag: "Availability",  principle: "Scarcity",                    title: "Only 3 projects per month.",                          sub: "I work end-to-end on each — I can't scale without sacrificing quality." },
      { tag: "Perks",         principle: "Reciprocity",                 title: "Before you decide, this is on me.",                   sub: "Three real deliverables with zero strings — so you see how I work." },
      { tag: "Cases",         principle: "Social proof",                title: "We already did this, 20 times.",                       sub: "The numbers and the brands that back every claim." },
      { tag: "Plans",         principle: "Perceptual contrast",         title: "Three plans, side by side.",                           sub: "Pick the one that fits your need. It gets tuned in the call." },
      { tag: "Stack",         principle: "Borrowed authority",          title: "Same stack Netflix, Anthropic and Vercel use.",        sub: "I don't chase trending tech; I use what real production has validated." },
      { tag: "Decision",      principle: "Commitment + consistency",    title: "Three short questions and you're in.",                sub: "We close on a concrete next step, no ambiguity." },
    ],
    anchor: {
