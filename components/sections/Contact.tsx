...
export function Contact({ lang }: { lang: Lang }) {
  ...
  const heading = isRecruiter
    ? lang === "es"
      ? "¿Buscas talento? Hablemos."
      : "Looking for talent? Let's talk."
    : lang === "es"
      ? "¿Tienes una idea? Empecemos a hablar."
      : "Got an idea? Let's start talking."

  const mailSubject = isRecruiter
    ? lang === "es"
      ? "Oportunidad laboral — Steven Villamizar"
      : "Job opportunity — Steven Villamizar"
    : lang === "es"
      ? "Nuevo proyecto — Steven Villamizar"
      : "New project — Steven Villamizar"

  const waMsg = isRecruiter
    ? lang === "es"
      ? "Hola Steven, tengo una oportunidad laboral que quisiera comentarte."
      : "Hi Steven, I have a job opportunity I'd like to discuss."
    : lang === "es"
      ? "Hola Steven, me gustaria agendar una llamada para un proyecto."
      : "Hi Steven, I'd like to schedule a call about a project."
      ...
      <div className="mx-auto grid max-w-6xl gap-16 lg:grid-cols-[220px_1fr] lg:gap-24">
        ...
        >
          ...
          <div className="mt-16 flex flex-wrap items-center gap-6">
            <a
              href={`mailto:Stevenvilla10@gmail.com?subject=${encodeURIComponent(mailSubject)}`}
            ...
            <a
              href={`https://wa.me/573046467135?text=${encodeURIComponent(waMsg)}`}
              target="_blank"
