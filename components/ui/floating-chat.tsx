...
const KNOWLEDGE_BASE = {
  es: [
    ...
    // Generales
    { keywords: ["experiencia", "trabajo", "rol", "carrera", "años", "anos"], answer: "Steven tiene 2+ años construyendo software profesional. Actualmente lidera el stack de ORAL-PLUS (SKY S.A.S) — migró el sistema legacy a Next.js + Node, integró agentes IA y maneja la pasarela de pagos." },
    ...
    { keywords: ["hola", "saludos", "buenas", "buenos dias", "buenas tardes", "hey"], answer: "Hola. Soy el copiloto del portafolio. Puedes preguntar por experiencia, stack, cualquier proyecto (Tonsorium, Alien Style, Beat Generator AI, Finanzas Pro, Inventory SaaS, ORAL-PLUS…), tarifas o disponibilidad." },
    ...
    { keywords: ["proyecto", "proyectos", "trabajos"], answer: "Proyectos en producción: Tonsorium (barbería premium), Alien Style 51 (estampados), Beat Generator AI (música + IA), Finanzas Pro (finanzas personales), Inventory SaaS (inventario multi-tenant), Enterprise Dashboard (analytics RRHH), ORAL-PLUS (ecosistema web + app + pagos), Digital CV (este sitio). Pregúntame por cualquiera para ver detalles." },
  ...
  en: [
    ...
    { keywords: ["experience", "work", "role", "career", "years"], answer: "Steven has 2+ years building professional software. Currently leading the stack at ORAL-PLUS (SKY S.A.S) — migrated legacy systems to Next.js + Node, integrated AI agents and built the payment gateway." },
    ...
    { keywords: ["hello", "hi", "greetings", "hey"], answer: "Hi. I'm the portfolio copilot. Ask about experience, stack, any project (Tonsorium, Alien Style, Beat Generator AI, Finanzas Pro, Inventory SaaS, ORAL-PLUS…), rates or availability." },
    ...
    { keywords: ["project", "projects", "works"], answer: "Projects in production: Tonsorium (premium barbershop), Alien Style 51 (custom prints), Beat Generator AI (music + AI), Finanzas Pro (personal finance), Inventory SaaS (multi-tenant inventory), Enterprise Dashboard (HR analytics), ORAL-PLUS (web + app + payments), Digital CV (this site). Ask me about any of them for details." },
