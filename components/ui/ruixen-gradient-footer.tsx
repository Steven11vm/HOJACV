...
// Ruixen Gradient Footer — Muji-adapted.
// El original venia con paleta rainbow (ember → azul → amarillo → magenta).
// Aqui va en escala de grises: base near-black que se funde con el fondo,
// mid-tones progresivos y un pico blanco cerca del top, transparente al final.
// Efecto: un halo blanco discreto que se enciende segun scrolleas al final.
// Un solo <svg> inline, sin canvas ni scroll spacer.
...
// Stops floor (0) → top (1): near-black invisible → grises progresivos → blanco → transparente.
const MUJI_STOPS: Stop[] = [
  { offset: 0, color: "#0a0a0a" },
  { offset: 0.2, color: "#171717" },
  { offset: 0.42, color: "#3a3a3a" },
  { offset: 0.58, color: "#8a8a87" },
  { offset: 0.72, color: "#dcdcda" },
  { offset: 0.85, color: "#f4f4f2" },
  { offset: 1, color: "#ffffff00" },
]

// Curva de altura: falloff suave, silueta tipo piramide (mas alto al centro).
